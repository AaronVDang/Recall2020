...
import application.events.LoadFromDb;

public class Main extends Application
{
	
	// note: comments within this class may not be consistently formed
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			VBox homePage = recallHome.getHomePageSurfaceStack();
			...
			VBox addEventsWindow = recallAddEvent.addEventPageSurfaceStack();
			...
			VBox editEventsWindow = recallEditEvent.editEventPageSurfaceStack();
			...
			VBox deleteEventWindow = recallDeleteEvent.deleteEventPageSurfaceStack();
			...
			VBox verificationWindow = recallVerification.getVerifyDeleteAllEventsPageStack();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			LoadFromDb loadAllEventsOnStartup = new LoadFromDb(recallEvents, eventsPage, homeWindow, eventCount);
...
//			Button editEventButtonOnEventsPage = recallEvents.getEditEventBtn();
//			//ChoiceBox<String> editEventPageEventsToChooseFrom = recallEditEvent.getCurrentExistingEvents();
//			editEventButtonOnEventsPage.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> {
//				
//				recallEditEvent.clearCurrentExistingEvents();
//				
//				FlowPane eventContainer = recallEvents.getEventContainer();
